/**
 * SidebarUIMethods - Human-friendly Add Field modal with type cards and examples
 */

import type { ParserConfig } from '@/types';

export class SidebarUIMethods {
  // keep existing static methods; extending with a new modal-based add field dialog
  static showAddFieldDialog(config: ParserConfig, onMessage: (message: any)=>void): void {
    ...
    typeCards.forEach((btn, idx) => {
      ...
      btn.addEventListener('click', () => {
        ...
        setActive(btn);
        // Show attribute input only for attribute type
